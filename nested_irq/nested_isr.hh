...
// Requires you to choose some pins that you can view on a data analyzer or
// scope: Debug::Pin0 through Debug::Pin3 They should be of type FPin<>
//
...
// Assert: Debug Pin 2 toggle for at least a few milliseconds immediately after
// Debug Pin 1 goes low
//
// Additional tests: Swap priority of two ISRs and verify Debug Pin 0 goes high
// and low before Debug Pin 1 goes high.
//
...
static inline void test_nesting_isr() {
  ...
  // Create callback for high-priority ISR (Pinchange ISR = Debug 3 pin goes
  // high)
