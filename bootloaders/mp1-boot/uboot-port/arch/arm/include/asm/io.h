...
static inline void __raw_writesb(unsigned long addr, const void *data, int bytelen)
{
...
static inline void __raw_writesw(unsigned long addr, const void *data, int wordlen)
{
...
static inline void __raw_writesl(unsigned long addr, const void *data, int longlen)
{
 ...
 */
static inline void __memcpy_fromio(void *to, const volatile void __iomem *from, size_t count)
{
...
#define isa_eth_io_copy_and_sum(a, b, c, d) eth_copy_and_sum((a), __mem_isa(b), (c), (d))

static inline int isa_check_signature(unsigned long io_addr, const unsigned char *signature, int length)
{
	int retval = 0;
	do {
...
#define isa_eth_io_copy_and_sum(a, b, c, d) __readwrite_bug("isa_eth_io_copy_and_sum")
