...
#define DDRCTRL_MRCTRL0_MR_RANK_ALL (0x1 << DDRCTRL_MRCTRL0_MR_RANK_SHIFT)
...
#define DDRCTRL_DBGCAM_DATA_PIPELINE_EMPTY                                                                             \
	(DDRCTRL_DBGCAM_WR_DATA_PIPELINE_EMPTY | DDRCTRL_DBGCAM_RD_DATA_PIPELINE_EMPTY)
#define DDRCTRL_DBGCAM_DBG_Q_DEPTH                                                                                     \
	(DDRCTRL_DBGCAM_DBG_WR_Q_EMPTY | DDRCTRL_DBGCAM_DBG_LPR_Q_DEPTH | DDRCTRL_DBGCAM_DBG_HPR_Q_DEPTH)
