...
#define readw_poll_timeout(addr, val, cond, timeout_us) readx_poll_timeout(readw, addr, val, cond, timeout_us)

#define readl_poll_timeout(addr, val, cond, timeout_us) readx_poll_timeout(readl, addr, val, cond, timeout_us)

#define readq_poll_timeout(addr, val, cond, timeout_us) readx_poll_timeout(readq, addr, val, cond, timeout_us)
