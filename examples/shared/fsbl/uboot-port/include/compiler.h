...
#if defined(__BEOS__) || defined(__NetBSD__) || defined(__FreeBSD__) || defined(__sun__) || defined(__APPLE__)
#include <inttypes.h>
...
#define _uswap_64(x, sfx)                                                                                              \
	((((x)&0xff00000000000000##sfx) >> 56) | (((x)&0x00ff000000000000##sfx) >> 40) |                                   \
	 (((x)&0x0000ff0000000000##sfx) >> 24) | (((x)&0x000000ff00000000##sfx) >> 8) |                                    \
	 (((x)&0x00000000ff000000##sfx) << 8) | (((x)&0x0000000000ff0000##sfx) << 24) |                                    \
	 (((x)&0x000000000000ff00##sfx) << 40) | (((x)&0x00000000000000ff##sfx) << 56))
#if defined(__GNUC__)
